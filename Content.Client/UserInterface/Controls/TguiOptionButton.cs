...
{
    [Virtual]
    public class TguiOptionButton : ContainerButton
    {
        ...
        private PanelContainer _separator;
        ...
        public TguiOptionButton()
        {
            ...
            _separator = new PanelContainer()
            {
                MinWidth = 2f,
                MinHeight = 2f,
                VerticalExpand = true,
                StyleClasses = { StyleClass.LowDividerLowAlpha },
                Margin = new Thickness(6,0,6,0),
            };
            hBox.AddChild(_separator);
        ...
        {
            public TguiOptionButton Button { get; }
            ...
            public ItemSelectedEventArgs(int id, TguiOptionButton button)
            {
                Id = id;
                Button = button;
            }

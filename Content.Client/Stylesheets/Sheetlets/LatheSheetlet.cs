...
[CommonSheetlet]
public sealed class LatheSheetlet : Sheetlet<PalettedStylesheet>
{
    ...
    public override StyleRule[] GetRules(PalettedStylesheet sheet, object config)
    {
        ...
        return
        [
            E<Button>().Class("latheCategoryButton").Prop(Button.StylePropertyStyleBox, boxItemBackground),
            E<Button>().Class("latheCategoryButton").PseudoHovered().Prop(Button.StylePropertyStyleBox, boxSelected),
            E<Button>().Class("latheCategoryButton").PseudoPressed().Prop(Button.StylePropertyStyleBox, boxSelected),

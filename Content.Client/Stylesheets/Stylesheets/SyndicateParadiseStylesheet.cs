...
[Virtual]
public partial class SyndicateParadiseStylesheet : CommonStylesheet
{
    public override string StylesheetName => "SyndicateParadise";

    public override InterFontFamilyStack BaseFont { get; } // TODO: NotoFontFamilyStack is temporary
    ...
    private const int PrimaryFontSize = 10;
    ...
    public SyndicateParadiseStylesheet(object config, StylesheetManager man) : base(config)
    {
        BaseFont = new InterFontFamilyStack(ResCache);
        var rules = new[]
        {
            ...
            GetAllSheetletRules<SyndicateParadiseStylesheet, CommonSheetletAttribute>(man),
        };

...
[Virtual]
public partial class ParadiseStylesheet : CommonStylesheet
{
    public override string StylesheetName => "Paradise";
    ...
    public ParadiseStylesheet(object config, StylesheetManager man) : base(config)
    {
        ...
        var rules = new[]
        {
            ...
            GetAllSheetletRules<ParadiseStylesheet, CommonSheetletAttribute>(man),
        };
